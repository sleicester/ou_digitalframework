...
function ou_digital_futures_nations_preprocess_html(&$variables) {
...
*/
function ou_digital_futures_nations_breadcrumb($variables) {
...
*/
function ou_digital_futures_nations_preprocess_page(&$variables) {
...
*/
function ou_digital_futures_nations_preprocess_menu_block_wrapper(&$variables) {
 ...
 */
function ou_digital_futures_nations_radios($variables) {
  $element = $variables['element'];
  $attributes = array();
 ...
 */
function  ou_digital_futures_nations_radio($variables) {
  $element = $variables['element'];
