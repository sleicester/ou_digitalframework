...
* http://jqueryui.com
* Includes: jquery.ui.core.js, jquery.ui.widget.js, jquery.ui.mouse.js, jquery.ui.position.js, jquery.ui.draggable.js, jquery.ui.resizable.js, jquery.ui.accordion.js, jquery.ui.button.js, jquery.ui.dialog.js, jquery.ui.tabs.js, jquery.ui.tooltip.js
...
(function ($, window, document) {
    ...
    var pluginName = "accessibleMegaMenu",
        defaults = {
            ...
            clickToOpen: false // defaults to hover to open menu
        },
        Keyboard = {
            BACKSPACE: 8,
            COMMA: 188,
    ...
    AccessibleMegaMenu.prototype = (function () {
        ...
        _togglePanel = function (event, hide) {
            ...
            if($('.ou-logo').css('margin-top') && settings.menuClass === "int-nav-meta-list") {
            	logoMargin = Math.abs($('.ou-logo').css('margin-top').split('px')[0]) + 53;
            }
            ...
            if (hide) {
                ...
                panelHeight = topli.find('[aria-expanded]').filter('.' + settings.panelClass).height();
                
                if(panelHeight > 0 && settings.clickToOpen) {
                    menu.css('margin-bottom', panelHeight + logoMargin + 'px');
                } else {
                    menu.css('margin-bottom', '0px');
                }
        ...
        return {
            ...
            init: function () {
				...
				// Disable mouseover and out settings for and enable Click to open
				if (settings.clickToOpen) {
					menu.off("mouseover.accessible-megamenu")
							.off("mouseout.accessible-megamenu")
							.off("mousedown.accessible-megamenu")
							.on("click.accessible-megamenu", $.proxy(_clickHandler, this));
				}
